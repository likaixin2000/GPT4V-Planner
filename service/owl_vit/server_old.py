# This file is deprecated and not used anywhere. It is kept for reference.
...
# # For compiling pycocotools
# conda install -c conda-forge gcc
# pip install -r ./requirements.py

# # Install jax gpu version. Please change the cuda version that fits your environment.
...
# Launch with `XLA_PYTHON_CLIENT_PREALLOCATE=false` to save memory.
