...
class AssemblingKitsSeqUnseenColors(Task):
    ...
    def reset(self, env):
        ...
        colors = [simulation_utils.COLORS[cn] for cn in color_names]
        ...
        for i in range(n_objects):
            ...
            pos = simulation_utils.apply(kit_pose, targ_pos[i])
            ...
            if list(obj_shapes).count(obj_shapes[i]) > 1:
                ...
                other_poses = [simulation_utils.apply(kit_pose, targ_pos[d]) for d in duplicate_shapes]
