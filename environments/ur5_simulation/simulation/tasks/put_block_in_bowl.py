...
class PutBlockInBowlUnseenColors(Task):
    ...
    def reset(self, env):
        ...
        colors = [simulation_utils.COLORS[cn] for cn in selected_color_names]
        ...
        distractor_bowl_colors = [simulation_utils.COLORS[c] for c in simulation_utils.COLORS if c not in selected_color_names]
        distractor_block_colors = [simulation_utils.COLORS[c] for c in simulation_utils.COLORS if c not in selected_color_names]
    ...
    def get_colors(self):
        return simulation_utils.TRAIN_COLORS if self.mode == 'train' else simulation_utils.EVAL_COLORS
...
class PutBlockInBowlSeenColors(PutBlockInBowlUnseenColors):
    ...
    def get_colors(self):
        return simulation_utils.TRAIN_COLORS
...
class PutBlockInBowlFull(PutBlockInBowlUnseenColors):
    ...
    def get_colors(self):
        all_colors = list(set(simulation_utils.TRAIN_COLORS) | set(simulation_utils.EVAL_COLORS))
        return all_colors