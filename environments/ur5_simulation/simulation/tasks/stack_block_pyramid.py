...
class StackBlockPyramid(Task):
    ...
    def reset(self, env):
        ...
        # Block colors.
        colors = [
            simulation_utils.COLORS['purple'], simulation_utils.COLORS['blue'], simulation_utils.COLORS['green'],
            simulation_utils.COLORS['yellow'], simulation_utils.COLORS['orange'], simulation_utils.COLORS['red']
        ]
