...
class PlaceRedInGreen(Task):
    ...
    def reset(self, env):
        ...
        bowl_colors = [simulation_utils.COLORS[c] for c in simulation_utils.COLORS if c != 'green']
        block_colors = [simulation_utils.COLORS[c] for c in simulation_utils.COLORS if c != 'red']
