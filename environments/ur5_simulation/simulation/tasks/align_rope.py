...
class AlignRope(Task):
    ...
    def reset(self, env):
        ...
        corner0 = simulation_utils.apply(square_pose, corner0)
        corner1 = simulation_utils.apply(square_pose, corner1)
        corner2 = simulation_utils.apply(square_pose, corner2)
        corner3 = simulation_utils.apply(square_pose, corner3)
        ...
        for i in range(n_parts):
            ...
            if (i > 0) and (i < n_parts - 1):
                color = simulation_utils.COLORS['red'] + [1]
