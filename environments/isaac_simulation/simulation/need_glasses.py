...
class NeedGlasses(Task):
    ...
    def reset(self):
        ...
        self.target_object_name = "glasses"
        self.target_object_path = "glasses/glasses.urdf"
        self.reference_object = ("iphone","iphone/iphone.urdf")
        self.place_position_info = self.position_helper.get_random_position()
        

        # 3. define prompt
        self.tast_prompt = f"I plan to use my iphone but my eyes are bad, put what I need {self.place_position_info['words']} the iphone."
