...
class FeelHungry(Task):
    ...
    def reset(self):
        ...
        help_objects = self.object_helper.get_selects_by_feature("object for eat")
        ...
        # 3. define prompt
        self.tast_prompt = f"I am feeling hungry, put what I need {self.place_position_info['words']} the {self.reference_object[0]}."
