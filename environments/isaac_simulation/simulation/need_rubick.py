...
class NeedRubick(Task):
    ...
    def reset(self):
        ...
        self.target_object_name = "rubick"
        self.target_object_path = "rubick/cube.urdf"
        ...
        # 3. define prompt
        self.task_prompt = f"I plan to use my iphone but my eyes are bad, put what I need {self.place_position_info['words']} the iphone."
