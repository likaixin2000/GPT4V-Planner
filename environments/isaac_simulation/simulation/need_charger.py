...
class NeedCharger(Task):
    ...
    def reset(self):
        ...
        self._env.add_object_relative_to_table("iphone","iphone/iphone.urdf",[-0.05, 0.3, 0.01],[0., 0, 1, -0.5 * np.pi],fix_base_link=True)
        ...
        # add distractor
        self._env.add_object_relative_to_table("bowl","bowl/model.urdf",[-0.1, -0.35, 0.02],[0., 0, 1, 0.5 * np.pi])
        #绕x轴旋转90度，再绕z轴旋转90度
